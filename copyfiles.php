...
$src = '../include/templater/plugins/modifier.cgpgiftcarddetails.php';
$dst = 'cardgateplus/include/templater/plugins/modifier.cgpgiftcarddetails.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../skin/common_files/payments/cc_cgp_giftcard.tpl';
$dst = 'cardgateplus/install_cardgateplus/files/payments/cc_cgp_giftcard.tpl';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../skin/common_files/customer/main/payment_cgp_ideal.tpl';
$dst = 'cardgateplus/install_cardgateplus/files/customer/main/payment_cgp_ideal.tpl';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../skin/common_files/customer/main/payment_cgp_giftcard.tpl';
$dst = 'cardgateplus/install_cardgateplus/files/customer/main/payment_cgp_giftcard.tpl';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
...
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
$src = '../payment/cc_cgp_giftcard.php';
$dst = 'cardgateplus/payment/cc_cgp_giftcard.php';
$is_dir = false;
array_push( $data, data_element( $src, $dst, $is_dir ) );
