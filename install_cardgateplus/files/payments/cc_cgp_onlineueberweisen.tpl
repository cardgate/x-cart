{*
$Id: cc_cgp_onlineueberweisen.tpl,v 0.1 2008/08/21 09:53:14 max Exp $
vim: set ts=2 sw=2 sts=2 et:
*}
<h3>CardGatePlus OnlineÜberweisen</h3>
...
<tr>
	<td>Control URL:</td>
	<td>{$http_location}/payment/cc_cgp_onlineueberweisen.php</td>
</tr>
<tr>
	<td>Mode</td>
	<td>
