...
############################# End ############################
	...
	class cgp_onlineueberweisen extends cgp_generic {
	}
	
	$cardgateplus = new cgp_onlineueberweisen('onlineueberweisen');
	
	// Exit if the CardGatePlus Payment method is not activated.
	if (!func_is_active_payment("cc_cgp_onlineueberweisen.php"))
